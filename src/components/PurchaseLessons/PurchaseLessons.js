        ...
        <Card className="mr-3 custom-card-styles" style={{ width: '18rem' }}>
          ...
          <Card.Body className="snapshot-card">
            <Card.Title className="snapshot-card-title">
              Tackling and Game Tactics Lorem ipsum dolor Game Tactics Lorem ipsum dolor with Cobus
              Reinach
            </Card.Title>
            <Card.Text className="snapshot-card-desc">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ut eum similique repellat a
